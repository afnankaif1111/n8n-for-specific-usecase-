...
export function BackpackTriggerNode(props: NodeProps) {
  ...
  return (
    <div className="min-w-[220px] rounded-xl border-2 border-border bg-card p-3 shadow-md transition-all hover:border-rose-500/50 text-left">
      {/* Header */}
      <div className="flex items-center justify-between pb-2 border-b border-border/60">
        <div className="flex items-center gap-2">
          ...
          <div>
            ...
            <div className="text-xs font-bold leading-none text-foreground">Economic Calendar</div>
          </div>
        </div>
      ...
      <div className="pt-2 text-xs font-medium text-foreground">
        {data.label || 'US NFP Payrolls / CPI Release'}
      </div>
      {data.subtitle && (
...
export const NewsTriggerNode = BackpackTriggerNode
