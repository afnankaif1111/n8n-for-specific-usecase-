...
export function BackpackActionNode(props: NodeProps) {
  ...
  return (
    <div className="min-w-[220px] max-w-[260px] rounded-xl border-2 border-border bg-card p-3 shadow-md transition-all hover:border-rose-500/50 text-left">
      <Handle
        type="target"
      ...
      <div className="flex items-center justify-between pb-2 border-b border-border/60">
        <div className="flex items-center gap-2">
          ...
          <div>
            ...
            <div className="text-xs font-bold leading-none text-foreground">Backpack Spot</div>
          </div>
        </div>
      ...
      <div className="pt-2 space-y-1">
        <div className="text-xs font-medium text-foreground">
          {data.label || 'Backpack Spot Order'}
        </div>
        {data.subtitle && (
      ...
      <Handle
        ...
        id="source-bottom"
        className="!h-2.5 !w-2.5 !rounded-full !bg-rose-500 !border-2 !border-background opacity-60 hover:opacity-100"
      />
    </div>
  )
}
