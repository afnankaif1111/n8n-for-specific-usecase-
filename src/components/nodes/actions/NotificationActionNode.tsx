...
export interface NotificationActionData extends Record<string, unknown> {
  label: string
  actionKind?: 'notification'
  subtitle?: string
}

export function NotificationActionNode(props: NodeProps) {
  const data = props.data as unknown as NotificationActionData
